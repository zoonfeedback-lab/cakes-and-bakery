        ...
        <div className="relative min-h-[260px] overflow-hidden px-5 py-8 sm:min-h-[300px] sm:px-8 sm:py-10 md:min-h-[340px] md:px-12 md:py-12">
          ...
          <div className="relative z-10 flex h-full flex-col">
            <div className="max-w-sm">
              <h1 className="section-title text-3xl leading-[0.92] sm:text-4xl md:text-5xl lg:text-6xl">
                {title}
              </h1>
            ...
            <div className="mt-6 sm:mt-8 flex justify-center w-full md:w-[70%]">
              <Link
                href="#cakes-grid"
                className="btn-primary inline-flex w-full sm:w-auto sm:min-w-[190px] justify-center"
              >
                Explore Collection
              </Link>
            </div>
