                ...
                <div className="relative min-h-[340px] overflow-hidden px-10 py-10 md:px-12 md:py-12">
                    ...
                    <div className="relative z-10 flex h-full flex-col">
                        <div className="max-w-sm">
                            <h1 className="section-title text-5xl leading-[0.92] md:text-6xl">{title}</h1>
                        ...
                        <div className="mt-8 flex w-[28%] min-w-[320px] justify-center">
                            <Link href="#bakes-grid" className="btn-primary inline-flex min-w-[190px] justify-center">
                                Explore Collection
                            </Link>
                        </div>
                    </div>
